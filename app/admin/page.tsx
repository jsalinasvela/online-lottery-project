              ...
              <div className="border-t border-slate-200 dark:border-slate-700 pt-4 mt-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, prizePercentage: parseInt(e.target.value) || 70 })
                      }
                      className="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100"
                    />
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                      Platform/Cause: {100 - formData.prizePercentage}%
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, causeName: e.target.value })}
                      className="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100"
                      placeholder="e.g., Albergue San Francisco"
                    />
                  </div>
                </div>
                ...
                <div className="mt-4">
                  ...
                  <textarea
                    ...
                    onChange={(e) => setFormData({ ...formData, causeDescription: e.target.value })}
                    className="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100"
                    rows={2}
                    placeholder="Describe the charitable cause..."
                  />
                </div>
              </div>

              {/* Winners Configuration Section */}
              <div className="border-t border-slate-200 dark:border-slate-700 pt-4 mt-4">
                <h4 className="text-md font-semibold text-slate-900 dark:text-slate-100 mb-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, winnerCount: parseInt(e.target.value) || 1 })
                      }
                      className="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100"
                    />
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
