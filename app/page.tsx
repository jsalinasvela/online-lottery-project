      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_1fr] gap-8 lg:gap-12">
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-xl border border-slate-200 dark:border-slate-700">
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-slate-900 dark:text-slate-100 text-sm mb-0.5">
